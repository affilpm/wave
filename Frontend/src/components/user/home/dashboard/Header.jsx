...
const Header = () => {
  ...
  return (
    <div className="h-16 bg-black flex items-center justify-between px-8 sticky top-0 z-50">
      ...
      {/* Right Section - Profile and Premium Button */}
      <div className="w-1/4 flex justify-end items-center gap-4">
        {/* Premium Button */}
        <button
          onClick={() => navigate('/premium')}
          className="bg-green-600 hover:bg-green-500 text-white text-sm font-medium px-4 py-2 rounded-full transition-colors"
        >
          Join Premium
        </button>
