...
const MobileChat = ({ messages, newMessage, setNewMessage, sendMessage, viewerCount, username, closeChat }) => {
  ...
  return (
    <div className="h-full flex flex-col bg-gradient-to-b from-black/60 to-black/80 backdrop-blur-sm rounded-t-xl">
      <div className="border-b border-gray-600/70 text-white">
      ...
      <div className="flex justify-around p-1.5 px-3 border-t border-gray-600/50">
      ...
      <div className="flex p-2.5 border-t border-gray-600/70">
        <input
          type="text"
          value={newMessage}
