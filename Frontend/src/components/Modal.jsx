...
const Modal = ({ isOpen, onClose, children }) => {
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-lg w-full max-w-4xl max-h-[90vh] h-auto p-6 relative mx-4 sm:mx-8 md:mx-16 lg:mx-32 overflow-auto custom-scrollbar">
        {/* Close Button */}
        <button
          type="button"
